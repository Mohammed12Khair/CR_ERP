                ...
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            @can('stock_report.view')
                                <!-- <li>
                                    <a href="#product_stock_transfer" data-toggle="tab" aria-expanded="true"><i
                                            class="fa fa-truck" aria-hidden="true"></i> @lang('report.trasfer_stock_cost')</a>
                                </li> -->
                            @endcan
                        </ul>
                        <div class="tab-content">
                            ...
                            @endcan
                            @can('stock_report.view')
                                <div class="tab-pane" id="product_stock_transfer">
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            product_table = $('#productD_table').DataTable({
                processing: true,
                serverSide: true,
                aaSorting: [
                    [3, 'asc']
