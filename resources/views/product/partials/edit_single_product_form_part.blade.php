                ...
                <tr>
                    <td>
                        ...
                        <div class="col-md" >
                          ...
                          {!! Form::text('single_dpp_inc_tax', @num_format($variation->dpp_inc_tax), ['class' => 'form-control input-sm dpp_inc_tax input_number', 'required']); !!}
                        </div>
                    </td>
                    ...
                    <td>
                        ...
                        {!! Form::text('single_dsp', @num_format($variation->default_sell_price), ['class' => 'form-control input-sm dsp input_number', 'placeholder' =>'', 'id' => 'single_dsp', 'required']); !!}
