...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-3" style="display: none;position:fixed;">
          <div class="form-group">
      ...
      {{-- <div class="clearfix"></div> --}}
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <br>
            <img src="{{ asset('img/index.jpg') }}" style="width:12%">
            <label>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div style="display: none;" class="col-sm-3 @if(!session('business.enable_price_tax')) hide @endif">
          <div class="form-group">
    ...
    <div class="col-sm-12">
      ...
      <div class="btn-group">
        @if($selling_price_group_count)
          <button type="submit" value="submit_n_add_selling_prices" class="btn btn-primary submit_product_form">@lang('lang_v1.save_n_add_selling_price_group_prices')</button>
        @endif

        @can('product.opening_stock')
        <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="btn btn-primary submit_product_form">@lang('lang_v1.save_n_add_opening_stock')</button>
        @endcan

        <button type="submit" value="save_n_add_another" class="btn btn-primary submit_product_form">@lang('lang_v1.save_n_add_another')</button>
