...
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('sell_list_filter_payment_type', __('cheque.status') . ':') !!}
        {!! Form::select('sell_list_filter_payment_type', ['cheque' => __('cheque.units')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
    </div>
</div>
