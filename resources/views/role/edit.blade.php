  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'expense.addpayment', in_array('expense.addpayment', $role_permissions),
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'expense.showpayments', in_array('expense.showpayments', $role_permissions),
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'users_accounts_admin', in_array('users_accounts_admin', $role_permissions),
