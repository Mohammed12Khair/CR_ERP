  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'checkout_multi_pay', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.checkout_multi_pay' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'express_checkout_card', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.express_checkout_card' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'express_checkout_cash', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.express_checkout_cash' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'quotation', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.quotation' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'draft', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'sale.draft' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'suspend', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.suspend' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'credit_sale', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.credit_sale' ) }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'expense.addpayment', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.expense_addpayment' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'expense.showpayments', false,
            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.expense_showpayments' ) }}
          </label>
        </div>
      </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-9">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::radio('radio_option[cheques_view]', 'all_cheques.access', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.view', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.accept', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.pay', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.details', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.delete', false,
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cheque.edit', false,
