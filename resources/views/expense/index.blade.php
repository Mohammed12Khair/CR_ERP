...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('expense_list_filter_payment_type', __('cheque.status') . ':') !!}
                    {!! Form::select('expense_list_filter_payment_type', ['cheque' => __('cheque.units')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
                </div>
            </div>
