            ...
            <div class="inner">
                  ...
                  <table class="table no-margin no-border table-slim">
                        ...
                        <tr>
                              ...
                              <td><span class="label @if($order->res_order_status == 'cooked' ) bg-red @elseif($order->res_order_status == 'served') bg-green @else bg-light-blue @endif">@lang('restaurant.order_statuses.' . $order->res_line_order_status) </span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                              ...
                              <td>{{$order->service_staff_name ?? ''}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                              ...
                              <td> {!! nl2br($order->sell_line_note ?? '') !!}</td>
                        </tr>
                  </table>
            </div>
