            ...
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        ...
                        if ($business->pur_invoice_man == 0) {
                            echo '<input name="pur_invoice_man" type="checkbox" class="input-icheck" value="1" >';
                        } else {
                            echo '<input name="pur_invoice_man" type="checkbox" class="input-icheck" value="1"  checked>';
                        }
                        ?>
