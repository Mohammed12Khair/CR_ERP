...
<div class="login-form col-md-12 col-xs-12 right-col-content box_test" id="box_test" style="border: 1px solid re;">
    ...
    <div style="text-align:center;">
        <img src="img/logo.gif" style="width: 50%;margin-bottom:5%;">
        <h1 style="font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif">{{config('about.companyname')}}</h1>
    </div>
