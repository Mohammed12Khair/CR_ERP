...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($Transaction_Details as $Transaction_Detail) {
            array_push($labe_, strval($Transaction_Detail->type));
            array_push($labe_v, intval($Transaction_Detail->total));
        }
        ...
        $Data_labe_ = [];
        $Data_labe_v = [];
        foreach ($Transaction_sells as $Transaction_Detail) {
            array_push($Data_labe_, strval($Transaction_Detail->type));
            array_push($Data_labe_v, intval($Transaction_Detail->total));
        }
