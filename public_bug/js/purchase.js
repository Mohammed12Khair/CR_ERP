$(document).ready(function() {
        ...
        $('#search_product')
            .autocomplete({
                source: function(request, response) {
                    $.getJSON(
                        '/purchases/get_products', { location_id: $('#location_id').val(), term: request.term },
                        response
                    );
                },
                minLength: 2,
    ...
    $('#tax_id, #discount_type, #discount_amount, input#shipping_charges, \
        ...
        //Purchase table delete
        purchase_table_deleted = $('#purchase_table_deleted').DataTable({
            processing: true,
            serverSide: true,
            scrollY: "75vh",
            scrollX: true,
            ...
            //     __currency_convert_recursively($('#purchase_table_deleted'));
            // },
    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                if ($('#purchase_list_filter_payment_type').length) {
                    d.payment_type = $('#purchase_list_filter_payment_type').val();
                }
    ...
    $(document).on(
        ...
        '#purchase_list_filter_location_id, \
                    #purchase_list_filter_supplier_id, #purchase_list_filter_payment_status,\
                     #purchase_list_filter_status,#purchase_list_filter_payment_type',
        function() {
            // alert("Change");
