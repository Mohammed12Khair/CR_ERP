$(document).ready(function() {
    ...
    expense_table = $('#expense_table').DataTable({
        ...
        ajax: {
            url: '/expenses',
            data: function(d) {
                d.payment_type = $('select#expense_list_filter_payment_type').val();
    ...
    $('select#location_id, select#expense_for, select#expense_contact_filter, select#expense_category_id, select#expense_payment_status,select#expense_list_filter_payment_type').on(
        'change',
        function() {
            expense_table.ajax.reload();
        }
