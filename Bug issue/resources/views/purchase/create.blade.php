	...
	<div class="row">
		<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
			...
			<div id="supplier_address_div">
				<!-- <a id="refund_enable" class="btn btn-sm btn-info">الريفند</a> -->
			</div>
		</div>
		<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
			<div class="form-group">
		...
		<div class="col-sm-12">
			...
			<div class="pull-right col-md-5">
				<table class="pull-right col-md-12">
					...
					<tr>
						<th class="col-md-7 text-right">refund total</th>
						<td class="col-md-5 text-left">
							<!-- <span id="refund_total" class="refund_total"></span> -->
							<!-- This is total before purchase tax-->
							<input type="number" class="refund_total" id="refund_total" value=0 name="refund_total" readonly="true">
						</td>
					</tr>
				</table>
			</div>
