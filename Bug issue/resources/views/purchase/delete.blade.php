...
<section class="content-header">
    ...
    @csrf     <input name="transaction_id" value="{{$id}}" type="text" hidden>
        ...
        <br>
        <!-- <label for="x">@lang('lang_v1.deleteResone')</label> -->
        <textarea style="height: 100px;" id="x" maxlength="500" name="deletereasone" type="text" class="form-control" required></textarea>
        <br>
