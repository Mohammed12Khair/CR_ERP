...
<div class="row">
	...
	@if(!empty($brands))
		<div class="col-sm-4" id="product_brand_div" style="display: none;">
	...
	<div class="col-sm-4 @if(empty($featured_products)) hide @endif" id="feature_product_div" style="display: none;">
