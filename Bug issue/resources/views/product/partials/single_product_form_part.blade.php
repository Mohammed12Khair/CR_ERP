        ...
        <tr>
          <td>
            ...
            <div class="col">
              ...
              {!! Form::text('single_dpp_inc_tax', $default, ['class' => 'form-control input-sm dpp_inc_tax input_number', 'placeholder' => '', 'required']); !!}
            </div>
          </td>
          ...
          <td>
            ...
            {!! Form::text('single_dsp', $default, ['class' => 'form-control input-sm dsp input_number', 'placeholder' => '', 'id' => 'single_dsp', 'required']); !!}
