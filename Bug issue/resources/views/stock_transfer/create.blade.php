	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<div class="row container">
				<div class="col-sm-4">
					<div class="form-group">
						{!! Form::label($expense_categorie->name,$expense_categorie->name) !!}
						{!! Form::text('expense_value[]', 0, ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.shipping_charges')]); !!}
						<input type="text" name="expense[]" value="{{$expense_categorie->id}}" hidden>
					</div>
				</div>
			</div>
			@endforeach
