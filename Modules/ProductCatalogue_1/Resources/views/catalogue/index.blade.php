                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            @foreach ($categories as $key => $value)
                                <li><a href="#category{{ $key }}" class="menu">{{ $value }}</a>
                                </li>
                            @endforeach
                        ...
                        <div class="col-md-3 eq-height-col col-xs-12">
                            <div class="box box-solid product-box">
                                <div class="box-body">
                                    ...
                                    <?php
                                    function Get_Price($product_id, $price_group_id)
                                    {
                                    ...
                                    // echo '_________' . Get_Price($product->id, $selling_Group_val);
                                    // echo '_________Seleing=>' . $selling_Group_val;
                                    // echo '_________Seleing=>' . $product->id;
                                        ...
                                        <tr>
                                            ...
                                            <td class="pb-0">
                                                ...
                                                <span class="display_currency" data-currency_symbol="true">
                                                    <?php
                                                    echo Get_Price($product->id, $selling_Group_val);
                                                    ?>
                                                </span>
                                            </td>
                                        </tr>
