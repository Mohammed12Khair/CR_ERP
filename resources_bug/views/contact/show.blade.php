...
<section class="content no-print">
  ...
  border:0px !important;
        ...
        <div class="info_col2" style="width: 100%;">
                ...
                <ul class="nav nav-tabs nav-justified">
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#ledger_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-scroll" aria-hidden="true"></i> @lang('lang_v1.ledger')</a>
                    </li>
                    ...
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#purchases_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-arrow-circle-down" aria-hidden="true"></i> @lang( 'purchase.purchases')</a>
                    </li>
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#stock_report_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-hourglass-half" aria-hidden="true"></i> @lang( 'report.stock_report')</a>
                    </li>
                    @endif
                    ...
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#sales_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-arrow-circle-up" aria-hidden="true"></i> @lang( 'sale.sells')</a>
                    </li>
                    ...
                    <li class="
                                ...
                                @else
                                    ''
                                @endif">
                        <a href="#subscriptions_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-recycle" aria-hidden="true"></i> @lang( 'lang_v1.subscriptions')</a>
                    </li>
                    @endif
                    @endif
                    <li class="
                            ...
                            @endif
                            ">
                        <a href="#documents_and_notes_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-paperclip" aria-hidden="true"></i> @lang('lang_v1.documents_and_notes')</a>
                    </li>
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#payments_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> @lang('sale.payments')</a>
                    </li>
                    ...
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#reward_point_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-gift" aria-hidden="true"></i> {{ session('business.rp_name') ?? __( 'lang_v1.reward_points')}}</a>
                    </li>
                    @endif
                    ...
                    <li class="
                        ...
                        @else
                            ''
                        @endif">
                        <a href="#activities_tab" data-toggle="tab" class="btn btn-primary" aria-expanded="true"><i class="fas fa-pen-square" aria-hidden="true"></i> @lang('lang_v1.activities')</a>
                    </li>
